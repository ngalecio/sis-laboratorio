...
<body>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:right;">$ {{ number_format($factura->valor_subtotal, 2, '.', ',') }}</td>
                    <td style="text-align:right;">$ {{ number_format($factura->valor_iva, 2, '.', ',') }}</td>
                ...
                @endforeach
                    ...
                    <tr>
                        ...
                        <th style="background:#e7e7e7; text-align:right;">$
                            {{ number_format($facturas->sum('valor_subtotal'), 2, '.', ',') }}
                        </th>
                        <th style="background:#e7e7e7; text-align:right;">$
                            {{ number_format($facturas->sum('valor_iva'), 2, '.', ',') }}
                        </th>
                        <th style="background:#e7e7e7; text-align:right;">$
    ...
    <script type="text/php">
        if (isset($pdf)) {
                ...
                $pdf->page_text(30, 565, "Facturas", $font, $size, $color);
            }
        </script>
</body>
