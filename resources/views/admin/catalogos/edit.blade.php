...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('/admin/categorias/update/'.$categoria->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="slug" id="slug" required readonly value="{{ old('slug', $categoria->slug) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="descripcion" id="descripcion" class="form-control" rows="3"
                                        placeholder="Ingrese la descripción de la categoría">{{ old('descripcion', $categoria->descripcion) }}</textarea>
